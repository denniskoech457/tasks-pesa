...
<body>
    <div class="auth-page">
        <form class="auth-card" id="signinForm" action="/auth.php" method="POST"><input type="hidden" name="action" value="signin">
            ...
            <div class="form-group"><label>Password</label><input class="input" id="signinPassword" name="password" type="password" required></div><button class="primary-btn">Sign In</button><?php if (($_GET["error"] ?? "") === "invalid"): ?><p id="error" class="error">Invalid email or password.</p><?php else: ?><p id="error" class="error"></p><?php endif; ?><p>No account? <a href="/signup.php" style="color:var(--primary);font-weight:900">Create Account</a></p>
        </form>
    </div>
    <script>
